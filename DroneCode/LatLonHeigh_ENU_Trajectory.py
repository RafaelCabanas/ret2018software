...
if __name__ == '__main__':
    ...
    print('Do you want to convert coordinates from your log drone file GPS lat, lon, alt into to ENU?')
    print('This option converts your log drone file to CVS, produces a clean CSV and plots ENU coordinates, using FIRST data point as origin of TLP')
    yN_file=input("(y/n)")

    file_name=get_file_name(yN_file)
    convert_CSV(file_name[0],file_name[1])  # full name of file = file_name[0]
                                            # extension = file_name[1]
    gps_dataframe, cleanCSVName=clean_CSV(file_name[0],file_name[1])  # returns a DataFrame with columns ['timestamp','Lat','Lon','Alt']
